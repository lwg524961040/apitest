 ...
 */
@RestController
@Api(tags = {"GDCBI user management"})
@RequestMapping(ControllerConstant.API_SYSTEM_PREFIX + "gdcbiuser")
public class SysGdcbiuserController extends BaseController {

    /**
     * Describe: 基础路径
     */
    private static String MODULE_PATH = "system/gdcbiuser/";
    ...
    @PreAuthorize("hasPermission('/system/gdcbiuser/main','sys:user:main')")

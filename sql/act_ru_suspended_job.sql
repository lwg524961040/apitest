DROP INDEX "ACT_FK_SUSPENDED_JOB_EXECUTION";
DROP INDEX "ACT_FK_SUSPENDED_JOB_PROCESS_INSTANCE";
DROP INDEX "ACT_FK_SUSPENDED_JOB_PROC_DEF";
DROP INDEX "ACT_FK_SUSPENDED_JOB_EXCEPTION";

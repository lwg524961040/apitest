DROP INDEX "ACT_FK_TIMER_JOB_EXECUTION";
DROP INDEX "ACT_FK_TIMER_JOB_PROCESS_INSTANCE";
DROP INDEX "ACT_FK_TIMER_JOB_PROC_DEF";
DROP INDEX "ACT_FK_TIMER_JOB_EXCEPTION";
